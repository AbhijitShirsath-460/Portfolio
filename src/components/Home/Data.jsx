  ...
  return (
    <div className="home_data">
      ...
      <p className="home_description">
        ...
        scalable digital experiences. Blending clean design with smart
        functionality, I explore AI, Generative AI, and emerging technologies to
        build innovative solutions that drive the future of tech.
      </p>
