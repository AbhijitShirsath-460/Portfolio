        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              <i className="bx bx-mail-send contact_card-icon email"></i>

              <h3 className="contact_card-title">Email</h3>

              <span className="contact_card-data">
                shirsathabhijit460@gmail.com
              </span>

              <a
                href="mailto:shirsathabhijit460@gmail.com.com"
            ...
            {/* whatsapp */}
            <div className="contact_card">
              <i className="bx bxl-whatsapp contact_card-icon whatsapp"></i>
              ...
              <a
                href="https://api.whatsapp.com/send?phone=9767330698&text=Hello Abhijit, Give more information!"
                className="contact_button"
              >
                Write me
                <i className="bx bx-right-arrow-alt  contact_button-icon"></i>
