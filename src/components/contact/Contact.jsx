...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_volzzqz', 'template_29ki66y', form.current, 'f3RjBFHIwVfyO_blq')
      .then((result) => {
                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">shirsathabhijit460@gmail.com</span>

                            <a href="mailto:shirsathabhijit460@gmail.com.com" className="contact_button">Write me
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">9767330698</span>

                            <a href="https://api.whatsapp.com/send?phone=9767330698&text=Hello, more information!" className="contact_button">Write me
                                <i className="bx bx-right-arrow-alt  contact_button-icon"></i></a>
                        </div>
                ...
                <div className="contact_content">
                    ...
                    <form  ref={form} onSubmit={sendEmail} className="contact_form">
                        ...
                        <div className="contact_form-div">
                            ...
                            <input type="text" className="contact_form-input" name='name' placeholder='Insert your name' />
                        </div>
